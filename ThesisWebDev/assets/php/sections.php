...
<form id="sectionForm" action="sectionSave.php" method="post">
    <div class="container">
                ...
                <table id="courseTable">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="sectionName[]" placeholder="Enter Section"></td>
...
async function fetchDataAndDisplay() {
    try {
        const response = await fetch('fetchSection.php');
